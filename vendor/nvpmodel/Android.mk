...
NVPMODEL_DATA_SYMLINK := $(TARGET_OUT)/etc/lib/nvpmodel
...
LOCAL_SRC_FILES            := $(COMMON_NVPMODEL_PATH)/bin64/ld-linux-aarch64.so.1
LOCAL_MODULE_CLASS         := EXECUTABLES
LOCAL_MODULE_TARGET_ARCH   := arm64
LOCAL_MODULE_TAGS          := optional
...
LOCAL_SRC_FILES            := $(COMMON_NVPMODEL_PATH)/lib64/libc.so.6
